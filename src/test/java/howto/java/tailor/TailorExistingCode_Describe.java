...
{    
    ...
    {   
        ...
        _class _c = Java._classFrom( TailorExistingCode_Describe.class );
        ...
        Java.call( adHocClass, "staticMessage", "Hello" );
        ...
        assertEquals( 1, Java.call( adHocInstance, "countMessage", "Msg1" ) );
        assertEquals( 1, Java.call( adHocInstance, "getCount" ) );
        assertEquals( 2, Java.call( adHocInstance, "countMessage", "Msg2" ) );
        assertEquals( 2, Java.call( adHocInstance, "getCount" ) );
    }    
}

    ...
    extends TestCase
{
    ...
    {
        _enum _e = _Java._enumFrom( TopLevelEnum.class );
        assertEquals( _e.getPackageName(), 
            TopLevelEnum.class.getPackage().getName() );
    }
    ...
    {
        _enum _e = _Java._enumFrom( NestedEnum.class );
        ...
        assertEquals( _e.getPackageName(), getClass().getPackage().getName() );
        assertTrue( _e.getImports().containsAll( 
            TestCase.class, _Java.class, _enum.class ) );
    }
}

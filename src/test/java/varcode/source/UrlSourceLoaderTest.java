...
import varcode.source.UrlSourceLoader;
	...
	extends TestCase
{
	...
	public void testGitHub()
	{
		...
		UrlSourceLoader urlRepo = new UrlSourceLoader( "GitHub Gist Examples", markupIdToURLMap );
	...
	{
		UrlSourceLoader urlRepo = new UrlSourceLoader( "github Gists" );
		...
		SourceStream markupStream = urlRepo.sourceStream( markupId );

...
import varcode.java.metalang._literal;
import varcode.java.metalang._arguments;
	...
	extends TestCase
{
    ...
    public void testBind()
    {
        ...
        assertEquals( "( 4 )", 
            _arguments.of("{+count+}").bind( VarContext.of( "count", 4 ) ).author( ) );
        
        assertEquals( "(  )", 
            _arguments.of("{+count+}").bind( VarContext.of( ) ).author( ) );
        
        assertEquals( "( 1, 2, 3, 4 )", 
            _arguments.of("{+count+}").bind( VarContext.of( "count", new int[]{1,2,3,4} ) ).author( ) );

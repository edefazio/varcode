...
import varcode.java.langmodel._methods._method._signature;
    ...
    extends TestCase
{
    ...
    public void testAnnotated()
    {
        ...
        assertEquals(
        "@Override" + N +
        "public void mustOverride(  );", m.toString() );
    }
    ...
    {        
        ...
        assertEquals( "public String M(  );", res.trim() );        
    }
    ...
    {        
        ...
        System.out.println( res );
        assertEquals( "public Gizmo method(  );", res.trim() );        
    }

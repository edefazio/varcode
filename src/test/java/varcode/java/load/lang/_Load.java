...
public class _Load
{
    public static final _Load INSTANCE = new _Load( JavaSourceLoader.INSTANCE );
            ...
            SourceLoader sourceLoader, Class<?> interfaceClass )
        {
            ...
            if( td instanceof ClassOrInterfaceDeclaration )
            {
                ...
                {                
                    ...
                    return JavaMetaLangCompiler._interfaceFromAST( _i, coid );
                }
                else
                {
                    throw new LoadException(
        ...
        public static _class _classOf( SourceLoader sourceLoader, Class<?> clazz )
        {
            ...
            if( td instanceof ClassOrInterfaceDeclaration )
            {
                ...
                {                
                    ...
                    return JavaMetaLangCompiler._classFromAST( _c, coid );
                }
                else
                {
                    throw new LoadException(

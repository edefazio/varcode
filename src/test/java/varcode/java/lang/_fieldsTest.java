    ...
    extends TestCase
{
    ...
    public void testBindInFields()
    {
        ...
        fs.bind( VarContext.of( "name", "idNumber" ) );
    ...
    public void testOne()
    {
        ...
        assertEquals( "public int a;", f.bind( VarContext.of() ).author().trim() );        
    }
    ...
    public void testParameterized()
    {
        ...
        assertEquals( "public int vn;", f.bind( VarContext.of() ).author().trim() );        

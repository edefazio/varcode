 ...
 * </BLOCKQUOTE> 
 * 
 * After loading a _class with {@code _Java._classFrom}, we can change it's name, 
 * modifiers, fields, methods, etc., and author / write the modified source, 
 * and/or create a new instance that can be used in an ad hoc manner.
 * 

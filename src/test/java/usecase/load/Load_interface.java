    ...
    extends TestCase
{
    ...
    {
        _interface _i = Java._interfaceFrom(
    ...
    {
        _interface _i = Java._interfaceFrom(ExInterface.class );
        assertEquals(_i.getPackage().getName(), 
            ExInterface.class.getPackage().getName() );
    }
    /** Load a _interface from runtime class using a custom SourceLoader */ 
    public void test_interfaceUsingCustomSourceLoader()
    {
        _interface _i = Java._interfaceFrom(DirectorySourceLoader.of( 
                System.getProperty( "user.dir" ) + "/src/test/java" ),
            ExInterface.class );
        
        assertEquals( _i.getPackage().getName(), ExInterface.class.getPackage().getName() );
    }
    ...
    {
        _interface _i = Java._interfaceFrom( NestedInterface.class );
        ...
        assertTrue(_i.getImports().containsAll(TestCase.class, Java.class, _class.class ) );
    }
}

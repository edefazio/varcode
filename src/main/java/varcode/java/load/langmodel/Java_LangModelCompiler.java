...
/**
 * "Compiles" the AST (Node-based) representation of 
 * Java Code into a LangModel (_class, _interface, _enum)
 * model.
 *
 * @author Eric DeFazio eric@varcode.io
 */
public class Java_LangModelCompiler
{
    public static final Logger LOG = 
        LoggerFactory.getLogger( Java_LangModelCompiler.class );
    
    /**
     * Creates and returns an _interface LangModel from the AST Root node 
     ...
     * @return the _interface LangModel representing the Java code.
     */
    ...
    /**
     * build/update an _interface LangModel based on the contents within a 
     * interface AST node  
     * @param _int the _interface model to update
     * @param astInterfaceDecl the interface declaration AST Node
     * @return the modified _interface LangModel 
     */
    ...
    /**
     * Creates and returns a _class LangModel from the AST Root node 
     ...
     * @return the _class LangModel representing the Java code.
     */
    ...
    /**
     * Build/Update a <CODE>_class</CODE> LangModel based on the <CODE>astClassDecl</CODE>
     * @param _c the _class LangModel to be updated / built
     * @param astClassDecl the AST classDeclaration root node
     * @return the updated _class LangModel
     */
    ...
    /**
     * updates an _enum LangModel based on the content stored within an 
     * <CODE>EnumDeclaration</CODE> AST enum Declaration.
     *
     * @param _e the _enum LangModel to be updated

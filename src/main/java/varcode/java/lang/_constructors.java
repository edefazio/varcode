    ...
    */
        ...
        implements _facet, JavaMetaLang
    {
        ...
        */
        ...
        /*
        public static _constructor of( String signature, Object... body )
        {
            _constructor ctor = new _constructor( signature );
            ctor.body( body );
            return ctor;
        }
        */
            ...
            implements JavaMetaLang
	{
		...
		String throwsTokens = constructorSpec.substring( 
                    closeParenIndex + 1 ).trim();
		if( throwsTokens.length() > 1 )
		{
			...
			throw new ModelException( 
                    ...
                    {
			throwsExceptions = _throws.of( 
                            (Object[])throwsTokensStrings );
                    }			
		}

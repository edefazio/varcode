...
{   
    ...
    @Override
    public _switch bind( VarContext context )
    {
        this.varName.bind( context );
    ...
    {   
        ...
        @Override
        public DefaultCase bind( VarContext context )
        {
            code = code.bind( context );
            return this;
        }
    ...
    {                
        ...
        @Override
        public Case bind( VarContext context )
        {
            caseEqual = caseEqual.bind( context );
    ...
    {                
        ...
        @Override
        public MultiCase bind( VarContext context )
        {
            for( int i = 0; i < caseEquals.length; i++ )
            {
                caseEquals[ i ] = caseEquals[ i ].bind( context );
            }
            code = code.bind( context );
            return this;
        }

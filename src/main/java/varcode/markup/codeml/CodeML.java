...
public enum CodeML
{
     ...
     */
    public static String composeAsString( 
        String codeMLMarkup, Object...keyValuePairs )
    {
     ...
     */
    public static String composeAsString( 
        String codeMLMarkup, VarContext context, Directive...directives )
    {
        Dom dom = compile( codeMLMarkup );
        return Compose.asString( dom, context, directives );
    }

    public static DocState composeToState( 
        String codeMLMarkup, Object...keyValuePairs )
    {
        Dom dom = compile( codeMLMarkup );
